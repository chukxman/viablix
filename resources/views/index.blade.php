...
<html lang="en">
  <head>
    <title>Viablix &mdash; AI-Powered Product Viability Assessment</title>
    <meta charset="utf-8">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.html">Viablix</a></div>
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  <h1  data-aos="fade-up" data-aos-delay="100">AI-Assessment</h1>
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200">Accelerate Your Path to Success: Our cutting-edge customer insights, and product potential to provide you with data-driven viability assessments. Turn ideas into impactful, profitable products with confidence.</p>
                  <p data-aos="fade-up" data-aos-delay="300"><a href="#" class="btn btn-primary py-3 px-5 btn-pill">Learn more</a></p>

                </div>

                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form action="{{ route('generate') }}" method="post" class="form-box">
                    @csrf
                    <h3 class="h4 text-black mb-4">Product Forecast</h3>
                    <div class="form-group">
                      <input type="text" class="form-control" name="productType" placeholder="Product">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control" name="price" placeholder="Price">
                    </div>
                    <div class="form-group mb-4">
                      <input type="text" class="form-control" name="region" placeholder="Location">
                    </div>
                    <div class="form-group">
                      <input type="submit" class="btn btn-primary btn-pill" value="Generate">
                    </div>
                  </form>
